...
const Desktop = () => {
    ...
    return (
        <>
                <div className={showButtons ? "min-h-screen bg-green-600 text-center text-color-black mt-0 pt-10 blur-xl" : "min-h-screen bg-green-600 text-center text-color-black mt-0 pt-10"}>
                {/*<WallpaperCircle />*/}
                </div>
